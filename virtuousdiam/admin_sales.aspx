<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_sales.aspx.vb" Inherits="admin_sales" %>
  ...
  <div class="container">
   ...
   <form id="form1" runat="server">
       <div class="form-container">
        <asp:TextBox ID="SaleIdTextBox" runat="server" placeholder="SaleId" ></asp:TextBox>                  
           <asp:Button ID="ShowButton" runat="server" Text="Show" />

           </div>
    <hr />
     <div>
             <asp:GridView class="GridItem" ID="GridItem" runat="server"></asp:GridView>
        </div>
       <hr />
            <div>
             <asp:GridView ID="SOLDDATA" class="GridItem" runat="server"></asp:GridView>
        </div>
    </form>
