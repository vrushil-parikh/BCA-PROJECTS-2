<%@ Page Language="VB" AutoEventWireup="false" CodeFile="admin_item.aspx.vb" Inherits="admin_item" %>
...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="ADMIN_HOME.aspx">Start Bootstrap</a>
    ...
    <form id="form1" runat="server">
       <div class="form-container">
        ...
        <asp:TextBox ID="TypeTextBox" runat="server" placeholder="Type"></asp:TextBox>
         <asp:TextBox ID="CostTextBox" runat="server" placeholder="Cost"></asp:TextBox>
