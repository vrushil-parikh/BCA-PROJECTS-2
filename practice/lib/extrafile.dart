...
import 'package:practice/popUpMenu.dart';
import 'dart:async';
              ...
              child: ListWheelScrollView(
                onSelectedItemChanged: (index){
                  ...
                  setState(() {
                    ...
                    itemExtent:170,
                    children: arrlist.map((value) => RotatedBox(
                      quarterTurns: 1,
                      child: Container(
                        ...
                        width: 120,
                        decoration: BoxDecoration(
                            color: (selected==value['rollno'])?Colors.red:Colors.blueGrey,
                        ...
                        child: Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              height: 100,
                              child: CircleAvatar(
                                backgroundImage: AssetImage('assets/images/${value['imgname']}'),
                              ),
                            ),
                            ...
                            Text('${value['stream']}',style: const TextStyle(
                                fontWeight: FontWeight.w700,
                                fontSize: 21,
                                color: Colors.white
                            ),)
  ...
  Widget build(BuildContext context) {
    ...
    void showToast(){
      Fluttertoast.showToast(
        msg: 'This is the simple toast example',
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Flutter Examples'),centerTitle: true,actions: [popUpMenu()],),
      drawer: appDrawer(),
      body: Center(child: ElevatedButton(
        child:const  Text('Show the toast message'),
        onPressed: (){
          showToast();
        },
      ),),
